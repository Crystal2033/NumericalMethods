...
QBoxLayout* ClassicSlider::createSlider(QBoxLayout &layout, Qt::Orientation sliderOrientation, const int left, const int right, const int curr)
{
    value = curr;
    ...
    if(sliderOrientation == Qt::Horizontal){
        classicLay->setContentsMargins(QMargins(40, 0, 40, 0));
