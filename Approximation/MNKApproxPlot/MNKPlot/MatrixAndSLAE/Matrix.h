...
public:
    ...
    double get(const unsigned int row, const unsigned int col) const;
	...
	int findRowForSwap(const int zeroRow, const int zeroCol) const;
...
private:
    ...
    unsigned int rowsValue = 0;
    unsigned int columnsValue = 0;
